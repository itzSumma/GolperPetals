...
                {bannerData[activeIndex].title} <span className="block text-red-300">{bannerData[activeIndex].subtitle}</span>
              </h1>
...
  {/* Background */}
  <div className="absolute inset-0 bg-gradient-to-b from-[#FFF8F8] via-[#FFFDFB] to-[#FFF5F2]" />

  {/* Decorative Blur */}
  <div className="absolute -top-32 -left-20 h-[420px] w-[420px] rounded-full bg-rose-300/20 blur-[120px]" />
  <div className="absolute top-1/2 -right-24 h-[380px] w-[380px] rounded-full bg-pink-300/20 blur-[120px]" />
  <div className="absolute bottom-0 left-1/2 h-[280px] w-[280px] -translate-x-1/2 rounded-full bg-orange-200/20 blur-[100px]" />

  
{/* Decorative Floating Elements */}
<div className="absolute left-12 top-20 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-rose-100 to-red-200/40 shadow-lg shadow-red-200/30 backdrop-blur-sm">
  <span className="text-4xl opacity-70">🌸</span>
</div>

<div className="absolute right-16 top-40 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-red-100 to-rose-200/40 shadow-md shadow-rose-200/30 backdrop-blur-sm">
  <span className="text-3xl opacity-70">🌹</span>
</div>

<div className="absolute bottom-24 left-1/4 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-pink-100 to-red-100/40 shadow-lg shadow-pink-200/30 backdrop-blur-sm">
  <span className="text-4xl opacity-70">💐</span>
</div>

<div className="absolute bottom-40 right-1/3 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-rose-100 to-pink-200/40 shadow-md shadow-red-200/30 backdrop-blur-sm">
  <span className="text-3xl opacity-70">🤍</span>
</div>
...
      <span className="inline-flex items-center rounded-full border border-rose-200 bg-white/80 px-5 py-2 text-sm font-semibold text-rose-700 backdrop-blur">
        ✨ Crafted with Love
      </span>

      <h2 className="mt-6 text-5xl font-black tracking-tight text-[#5A1E26]">
        Signature Blooms
      </h2>

      <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-gray-600">
        Every bouquet carries a story, waiting to become part of yours.
        Handcrafted with love to celebrate every smile, every memory,
...
    mass: 0.8,
  }}
  className="group overflow-hidden rounded-[32px] border border-white/70 bg-white/80 backdrop-blur-xl shadow-lg transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_25px_60px_rgba(220,38,38,0.18)]"
>
...
    <h3 className="text-2xl font-bold text-[#5A1E26] transition-colors duration-300 group-hover:text-red-700">
      {item.name}
    </h3>

    <p className="mt-2 text-2xl font-black text-rose-600 transition-transform duration-300 group-hover:scale-105">
      {item.price}
    </p>

    <button className="mt-6 w-full rounded-full bg-gradient-to-r from-rose-500 to-red-500 py-3 font-semibold text-white transition-all duration-500 hover:scale-[1.02] hover:from-red-600 hover:to-rose-600 hover:shadow-xl hover:shadow-red-300/40">
      View Details
    </button>
  </div>
</motion.div>
...
      {/* Footer / CTA Section */}
      <section className="bg-rose-800 py-20 px-6">
...
          <button className="mt-10 rounded-full bg-white/40 px-8 py-4 font-semibold text-red-900 transition text-red-400  hover:bg-rose-600 text-white">Explore All Bouquets</button>
        </div>
      </section>
    </div>
  );
